// $ANTLR 3.5.2 VSLLexer.g 2016-11-08 08:11:10
...
public class VSLLexer extends Lexer {
	...
	@Override public String getGrammarFileName() { return "VSLLexer.g"; }
	...
	public final void mFUNC_KW() throws RecognitionException {
		try {
			int _type = FUNC_KW;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// VSLLexer.g:27:11: ( 'FUNC' )
			// VSLLexer.g:27:13: 'FUNC'
			{
			match("FUNC"); 
	...
	public final void mPROTO_KW() throws RecognitionException {
		try {
			int _type = PROTO_KW;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// VSLLexer.g:28:11: ( 'PROTO' )
			// VSLLexer.g:28:13: 'PROTO'
			{
			match("PROTO"); 
	...
	public final void mINT_KW() throws RecognitionException {
		try {
			int _type = INT_KW;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// VSLLexer.g:29:11: ( 'INT' )
			// VSLLexer.g:29:13: 'INT'
			{
			match("INT"); 
	...
	public final void mVOID_KW() throws RecognitionException {
		try {
			int _type = VOID_KW;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// VSLLexer.g:30:11: ( 'VOID' )
			// VSLLexer.g:30:13: 'VOID'
			{
			match("VOID"); 
	...
	public final void mRETURN_KW() throws RecognitionException {
		try {
			int _type = RETURN_KW;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// VSLLexer.g:32:11: ( 'RETURN' )
			// VSLLexer.g:32:13: 'RETURN'
			{
			match("RETURN"); 
	...
	public final void mPRINT_KW() throws RecognitionException {
		try {
			int _type = PRINT_KW;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// VSLLexer.g:33:11: ( 'PRINT' )
			// VSLLexer.g:33:13: 'PRINT'
			{
			match("PRINT"); 
	...
	public final void mREAD_KW() throws RecognitionException {
		try {
			int _type = READ_KW;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// VSLLexer.g:34:11: ( 'READ' )
			// VSLLexer.g:34:13: 'READ'
			{
			match("READ"); 
	...
	public final void mTHEN_KW() throws RecognitionException {
		try {
			int _type = THEN_KW;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// VSLLexer.g:36:11: ( 'THEN' )
			// VSLLexer.g:36:13: 'THEN'
			{
			match("THEN"); 
	...
	public final void mELSE_KW() throws RecognitionException {
		try {
			int _type = ELSE_KW;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// VSLLexer.g:37:11: ( 'ELSE' )
			// VSLLexer.g:37:13: 'ELSE'
			{
			match("ELSE"); 
	...
	public final void mWHILE_KW() throws RecognitionException {
		try {
			int _type = WHILE_KW;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// VSLLexer.g:39:11: ( 'WHILE' )
			// VSLLexer.g:39:13: 'WHILE'
			{
			match("WHILE"); 
	...
	public final void mOD_KW() throws RecognitionException {
		try {
			int _type = OD_KW;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// VSLLexer.g:41:11: ( 'DONE' )
			// VSLLexer.g:41:13: 'DONE'
			{
			match("DONE"); 
	...
	public final void mIDENT() throws RecognitionException {
		try {
			int _type = IDENT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// VSLLexer.g:49:9: ( LETTER ( LETTER | DIGIT )* )
			// VSLLexer.g:49:11: LETTER ( LETTER | DIGIT )*
			{
			mLETTER(); 

			// VSLLexer.g:49:18: ( LETTER | DIGIT )*
			loop2:
			while (true) {
				int alt2=2;
	...
	public final void mTEXT() throws RecognitionException {
		try {
			int _type = TEXT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// VSLLexer.g:50:9: ( '\"' ( ASCII )* '\"' )
			// VSLLexer.g:50:11: '\"' ( ASCII )* '\"'
			{
			match('\"'); 
			// VSLLexer.g:50:15: ( ASCII )*
			loop3:
			while (true) {
				int alt3=2;
	...
	public final void mINTEGER() throws RecognitionException {
		try {
			int _type = INTEGER;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// VSLLexer.g:51:9: ( ( DIGIT )+ )
			// VSLLexer.g:51:11: ( DIGIT )+
			{
			// VSLLexer.g:51:11: ( DIGIT )+
			int cnt4=0;
			loop4:
	...
	public void mTokens() throws RecognitionException {
		// VSLLexer.g:1:8: ( WS | COMMENT | LP | RP | LB | RB | LC | RC | COM | FUNC_KW | PROTO_KW | INT_KW | VOID_KW | ASSIGN_KW | RETURN_KW | PRINT_KW | READ_KW | IF_KW | THEN_KW | ELSE_KW | FI_KW | WHILE_KW | DO_KW | OD_KW | PLUS | MINUS | MUL | DIV | IDENT | TEXT | INTEGER )
		int alt5=31;
		switch ( input.LA(1) ) {
		case '\t':
		case '\n':
